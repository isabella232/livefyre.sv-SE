...
Aktuell version: Chatt använder `fyre.conv v3.0.0.`
...
| datetimeFormat | *Object Function i* alternativsträngen | Anger datum/tid-formatet för direktuppspelat innehåll. Mer information finns i Anpassa datum- och tidsstämplar. |
...
| disableThirdPartyAnalytics | ** optionsAlbBoolean | Inaktiverar analyssystem från tredje part (Quantserve och Google Analytics) som Livefyre kan använda för interna mätningar. Standardvärdet är false. |
