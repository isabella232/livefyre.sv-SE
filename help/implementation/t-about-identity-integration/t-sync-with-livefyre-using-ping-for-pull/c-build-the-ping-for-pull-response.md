...
| Objektet *valfritt, men rekommenderas* | name | Strängar som definierar användarens formaterade, första, mellersta och efternamn. |
...
| Matris *valfri* | webbplatser | En array med användarskickade webbplatser. Max = 2. |
...
| Boolean *valfri* | moderator | Definierar om användaren har moderatorbehörighet i nätverket. |
| Boolean *valfri* | gravatar_disabled | Definierar om Livefyres användning av en gravatar ska inaktiveras om inget image_url anges. |

## Exempelsvar {#section_uxt_3dd_mz}
